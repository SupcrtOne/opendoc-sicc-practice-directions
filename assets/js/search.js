(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-sicc-practice-directions'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-sicc-practice-directions/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "Singapore International Commercial Court Practice Directions"
