(function () {
    ...
    editButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var repoUrl = 'https://github.com/opendocsg/opendoc-sicc-practice-directions' + '/blob/master/'
    ...
    printButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            var replacedRepoName = 'opendocsg/opendoc-sicc-practice-directions'.replace(/\//g, '-') + (isProd ? '' : '-staging')
            var pdfUrl = 'true' === 'true' ?
                '/opendoc-sicc-practice-directions/assets/pdfs' :
